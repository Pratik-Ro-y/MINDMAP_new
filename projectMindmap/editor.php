...
<div style="position: fixed; top: 10px; right: 10px; background: yellow; padding: 10px; z-index: 9999;">
    ...
    Is AI Map: <?php echo $isAIMap ? 'YES' : 'NO'; ?><br>
    Nodes Count: <?php echo count($nodes); ?><br>
    Title: <?php echo htmlspecialchars($mindmapData['title'] ?? 'N/A'); ?>
</div>
<?php else: ?>
<div style="position: fixed; top: 10px; right: 10px; background: red; color: white; padding: 10px; z-index: 9999;">
    <strong>ERROR: No nodes loaded!</strong>
</div>
<?php endif; ?>
...
if (nodes.length === 0) {
    ...
    console.log('renderExistingNodes called');
